...
package class Softnet: Network {
  ...
  package static func softnetExecutableURL() throws -> URL {
  ...
  package static func configureSUIDBitIfNeeded() throws {
