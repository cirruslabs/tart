...
extension Data {
  package func asText() -> String {
    String(decoding: self, as: UTF8.self)
  }
}

extension AsyncThrowingChannel<Data, Error> {
  package func asData() async throws -> Data {
    var result = Data()
...
package class Registry {
  ...
  package let credentialsProviders: [CredentialsProvider]
  package let authenticationKeeper = AuthenticationKeeper()
  ...
  package func ping() async throws {
  ...
  package func pushManifest(reference: String, manifest: OCIManifest) async throws -> String {
