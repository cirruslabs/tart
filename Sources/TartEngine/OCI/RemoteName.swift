...
package struct Reference: Comparable, Hashable, CustomStringConvertible {
  package enum ReferenceType: Comparable {
    case Tag
    case Digest
  }

  package let type: ReferenceType
  package let value: String

  package var fullyQualified: String {
    get {
      switch type {
      case .Tag:
        return ":" + value
  ...
  package init(digest: String) {
    type = .Digest
    value = digest
  }

  package static func <(lhs: Reference, rhs: Reference) -> Bool {
...
package struct RemoteName: Comparable, Hashable, CustomStringConvertible {
  package var host: String
  package var namespace: String
  package var reference: Reference

  package init(host: String, namespace: String, reference: Reference) {
    self.host = host
    self.namespace = namespace
    self.reference = reference
  }

 package init(_ name: String) throws {
  ...
  package static func <(lhs: RemoteName, rhs: RemoteName) -> Bool {
