...
package class KeychainCredentialsProvider: CredentialsProvider {

  package init() {

  }

  package func retrieve(host: String) throws -> (String, String)? {
  ...
  package func store(host: String, user: String, password: String) throws {
  ...
  package func remove(host: String) throws {
    let query: [String: Any] = [kSecClass as String: kSecClassInternetPassword,
                                kSecAttrServer as String: host,
                                kSecAttrLabel as String: "Tart Credentials",
    ]
