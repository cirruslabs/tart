...
extension VMDirectory {
  ...
  package func pullFromRegistry(registry: Registry, reference: String, concurrency: UInt) async throws {
  ...
  package func pullFromRegistry(registry: Registry, manifest: OCIManifest, concurrency: UInt) async throws {
  ...
  package func pushToRegistry(registry: Registry, references: [String], chunkSizeMb: Int, diskFormat: String) async throws -> RemoteName {
